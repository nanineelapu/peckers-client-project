                ...
                >
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row gap-[4vw] md:gap-4 py-[4vw] md:py-[2vw]">
                            <button
                                className="w-full md:w-auto text-[#ffff] px-[4vw] md:px-[1.1vw] py-[3vw] md:py-[.8vw] rounded-[2vw] md:rounded-[0.8vw] text-[4vw] md:text-[1.33vw] tracking-wide transition-all duration-300 hover:bg-[#232323]"
                                style={{
                            ...
                            <button
                                className="w-full md:w-auto text-black px-[4vw] md:px-[2.9vw] font-bold py-[3vw] md:py-[.8vw] rounded-[2vw] md:rounded-[0.8vw] text-[4.2vw] md:text-[1.4vw] tracking-wide transition-all duration-300 hover:bg-[#ffff] bg-[#ffff]"
                                style={{
                                    fontFamily: "monospace, 'Share Tech', 'ShareTech', 'Share_Tech', 'ShareTechMono'",

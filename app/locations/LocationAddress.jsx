    ...
    return(
        ...
        <div className="flex justify-center items-center min-h-[90vh] mt-6">
            ...
            >
                {/* Left Side (Info) */}
                <div
                    className="flex flex-col w-[50%]  pr-[0vw] mr-[2vw] "
                    style={{ borderRadius: '0.6vw', marginRight: '1vw', background: 'transparent', paddingRight:'2vw' }}
                >
                    <div className="text-white text-[3.6vw] tracking-[0.1vw] font-bold" style={{ fontFamily: "var(--font-peakers)" }}>
                        HITCHIN PECKERS
                    </div>
                    <div className="flex items-center gap-[1vw] mt-7 mb-2">
                        ...
                        <div className="text-[#e3e3e5] text-[1.2vw] py-[1vw] font-peakers">
                            25 Jhon Barker PI,<br />Hitchin SG5 2PD
                        </div>
                    </div>
                    <br />
                    <div className="flex items-center gap-[1.3vw] mb-2">
                        <svg width="25" height="35" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="text-[#e3e3e5] text-[1.2vw] font-peakers ">Monday - Sunday</div>
                    </div>
                    <br />
                    <div className="flex items-center gap-[1vw] mb-4">
                        ...
                        <div className="text-[#e3e3e5] text-[1.2vw] font-peakers">07599 828189</div>
                    </div>
                    <br />
                    <div className="flex gap-4 py-[2vw]">
                        <button
                            className="text-[#ffff] px-[1.1vw] py-[.8vw] rounded-[0.8vw] text-[1.33vw] tracking-wide transition-all duration-300 hover:bg-[#232323]"
                            style={{
                        ...
                        <button
                            className="text-black px-[2.9vw] font-bold py-[.8vw] rounded-[0.8vw] text-[1.4vw] tracking-wide transition-all duration-300 hover:bg-[#ffff] bg-[#ffff]"
                            style={{
                                fontFamily: "monospace, 'Share Tech', 'ShareTech', 'Share_Tech', 'ShareTechMono'",

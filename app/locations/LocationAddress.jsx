    ...
    return (
        <section>
            <div className="flex justify-center items-center min-h-[90vh] mt-6">
                <div
                    className="bg-[#121212] rounded-[18px] px-[6vw] md:px-[5vw] lg:px-10 py-[8vw] md:py-[4vw] lg:py-8 gap-[8vw] md:gap-[2vw] lg:gap-8 flex flex-col md:flex-row shadow-lg h-auto md:h-[77vh] lg:h-auto w-[90vw] md:w-[72vw] lg:w-[80vw]"
                ...
                >
                    ...
                    >
                        <div className="text-white text-[8vw] md:text-[3.6vw] lg:text-3xl tracking-[0.1vw] font-bold" style={{ fontFamily: "var(--font-peakers)", lineHeight: "1.1" }}>
                            {data.title}
                        </div>
                        <div className="flex items-center gap-[4vw] md:gap-[1vw] mt-7 mb-2">
                            ...
                            <div className="text-[#e3e3e5] text-[4vw] md:text-[1.2vw] lg:text-sm py-[1vw] font-peakers">
                                {data.address.split("\n").map((line, i, arr) => (
                        ...
                        <div className="flex items-center gap-[4vw] md:gap-[1.3vw] mb-2">
                            ...
                            <div className="text-[#e3e3e5] text-[4vw] md:text-[1.2vw] lg:text-sm font-peakers ">Monday - Sunday</div>
                        </div>
                        <br />
                        <div className="flex items-center gap-[4vw] md:gap-[1vw] mb-4">
                            ...
                            <div className="text-[#e3e3e5] text-[4vw] md:text-[1.2vw] lg:text-sm font-peakers">{data.phone}</div>
                        </div>
                        <br />
                        <div className="flex flex-col md:flex-row gap-[4vw] md:gap-4 py-[4vw] md:py-[2vw]">
                            <button
                                className="w-full md:w-auto text-[#ffff] px-[4vw] md:px-[1.1vw] lg:px-4 py-[3vw] md:py-[.8vw] lg:py-2 rounded-[2vw] md:rounded-[0.8vw] lg:rounded-lg text-[4vw] md:text-[1.33vw] lg:text-sm tracking-wide transition-all duration-300 hover:bg-[#232323]"
                                style={{
                            ...
                            <button
                                className="w-full md:w-auto text-black px-[4vw] md:px-[2.9vw] lg:px-6 font-bold py-[3vw] md:py-[.8vw] lg:py-2 rounded-[2vw] md:rounded-[0.8vw] lg:rounded-lg text-[4.2vw] md:text-[1.4vw] lg:text-sm tracking-wide transition-all duration-300 hover:bg-[#ffff] bg-[#ffff]"
                                style={{
                                    fontFamily: "monospace, 'Share Tech', 'ShareTech', 'Share_Tech', 'ShareTechMono'",
                    ...
                    <div
                        className="map-interactive h-[40vh] md:h-[58vh] lg:h-[50vh] w-full md:w-[50%] rounded-[2vw] md:rounded-[0.6vw] flex items-center justify-center mt-[4vw] md:mt-0 relative overflow-hidden"
                        style={{
                            border: '1px solid #333',
                            pointerEvents: 'auto',
                        }}

...
export default function CoopHeading({ heading = "OUR LOCATIONS", subtitle = "Experience our local vibe and flavour in person. Find your nearest Peckers below." }) {
  ...
  return (
    <div
      className="w-full px-[5vw] md:px-[1.4vw] py-[10vw] md:py-0 pt-[15vw] md:pt-[15vw] pb-[10vw] md:pb-[2vw] xl:pb-0 flex flex-col items-center md:items-start text-center md:text-left"

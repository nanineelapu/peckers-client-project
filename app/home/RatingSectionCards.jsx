      ...
      <div className="w-full px-[2vw] overflow-hidden">
        <div className="rating-marquee gap-[3vw] lg:gap-[1vw] items-stretch">
          {[...cards, ...cards].map((card, index) => (
            <div
              key={index}
              className="w-[80vw] min-w-[80vw] lg:w-[30vw] lg:min-w-[30vw] min-h-[28vw] lg:min-h-[12vw] h-auto bg-[#181818] rounded-[4vw] lg:rounded-[1vw] p-[5vw] lg:p-[2vw] flex flex-col shadow-lg border border-[#1F2937] relative shrink-0"
            >
              <div className="flex flex-row items-center justify-between mb-[3vw] lg:mb-[0.8vw]">
                <div className="flex flex-row items-center gap-[3vw] lg:gap-[0.8vw]">
                  <div
                    className={`w-[12vw] h-[12vw] min-w-[12vw] min-h-[12vw] lg:w-[2.7vw] lg:h-[2.7vw] lg:min-w-[2.7vw] lg:min-h-[2.7vw] rounded-full bg-gradient-to-br ${card.gradient} flex items-center justify-center text-white font-bold uppercase font-sans shadow-md`}
                  ></div>
                  <div className="flex flex-col">
                    <span
                      className="text-white font-extralight text-[4vw] lg:text-[1.3vw] leading-[1.2] uppercase tracking-[2px]"
                      style={{ fontFamily: "var(--font-peakers)" }}
                    >
                      {card.name}
                    </span>
                    <span
                      className="text-[#A1A1AA] font-mono text-[3vw] lg:text-[1vw] leading-tight mt-0"
                      style={{
                        fontWeight: 400,
                ...
                <svg
                  ...
                  className="w-[8vw] h-[7vw] lg:w-[3vw] lg:h-[2.5vw] shrink-0"
                >
                  <path
              ...
              <div className="text-[#b3b3b3] text-[3.5vw] lg:text-[1vw] font-extralight font-sans mt-[1vw] lg:mt-[0.15vw] leading-[1.5] lg:leading-[1.6] tracking-wide max-w-full flex-grow">
                {card.text}
              </div>
            </div>
          ))}

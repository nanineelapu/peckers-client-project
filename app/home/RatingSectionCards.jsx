...
export default function RatingSectionCards() {
  return (
    <div className="w-full mt-[0vw] mb-[5vw] px-[1vw]">
      ...
      <div className="flex flex-col lg:flex-row gap-[3vw] justify-center items-stretch">
        {/* Card 1 */}
        <div
          className="flex-1 min-w-[80vw] max-w-[98vw] lg:min-w-[28vw] lg:max-w-[32vw] bg-[#181818] rounded-[3vw] lg:rounded-[1vw] p-[5vw] lg:p-[2vw] flex flex-col shadow-lg border border-[#1F2937] relative"
        >
          ...
          <div className="text-[#b3b3b3] lg:text-[1vw] font-extralight lg:font-extralight font-sans mt-[1vw] lg:mt-[0.15vw] leading-[1.6] tracking-wide">
            "I would sell my soul for another basket<br />
             of the Lemon Pepper wings.Absolutely<br />
             unruly flavor."
          </div>
        </div>
        ...
        >
          ...
          <div className="text-[#b3b3b3] lg:text-[1vw] font-extralight lg:font-extralight font-sans mt-[1vw] lg:mt-[0.15vw] leading-[1.6] tracking-wide">
            "The music is loud, the decor is chaotic,<br />
             and the chicken is god-tier.10/10 would<br />
             destroy my shirt with sauce again."
          </div>
        </div>
        ...
        >
          ...
          <div className="text-[#b3b3b3] lg:text-[1vw] font- lg:font-extralight font-sans mt-[1vw] lg:mt-[0.15vw] leading-[1.6] tracking-wide">
            "Honestly, better than Wingstop. Yeah I <br />
            said it. Come fight me about it."
          </div>
        </div>
      </div>
    </div>

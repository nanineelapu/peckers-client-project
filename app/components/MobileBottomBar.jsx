export default function MobileBottomBar() {
    return (
        <div className="md:hidden fixed bottom-0 left-0 w-full bg-[#111] border-t border-[#333] shadow-[0_-10px_30px_rgba(0,0,0,0.5)] flex items-center gap-3 px-4 py-3 z-50 pb-[calc(14px+env(safe-area-inset-bottom))]">
            <button
                className="flex-1 flex items-center justify-center gap-2 bg-white text-black py-3.5 rounded-xl text-[15px] font-bold active:scale-95 transition-transform shadow-md tracking-wider leading-none"
            ...
            <button
                className="flex-1 flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white py-3.5 rounded-xl text-[15px] font-bold active:scale-95 transition-transform shadow-[0_4px_15px_rgba(220,38,38,0.4)] tracking-wider leading-none"
                style={{ fontFamily: "monospace, 'Share Tech', 'ShareTech', 'Share_Tech', 'ShareTechMono'" }}
            >
                <svg width="20" height="13" viewBox="0 0 17 11" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-[20px] h-auto">

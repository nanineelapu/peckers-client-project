    ...
    return (
        ...
        >
            ...
            <div className="flex items-start justify-between">
                ...
                {/* Left Title */}
                <h1 className="font-peakers text-[8vw] md:text-[4.2vw] font-bold tracking-[0.1vw] leading-none uppercase">
                    {initialData?.heading || "THE CREW"}
                </h1>

                {/* Right Text */}
                <p className="text-right font-semibold font-peakers text-[2.5vw] md:text-[.9vw] tracking-[0.1vw] pt-[1.5vw] text-gray-400 max-w-[35vw] uppercase">
            ...
            <motion.div
                ...
                whileInView="visible"
                viewport={{ once: true }}
                className="grid grid-cols-1 md:grid-cols-4 gap-[4vw] md:gap-[1.5vw]"
            >
                {crewMembers.map((member, index) => (
                    <motion.div
                        key={index}
                        variants={cardVariants}
                        className={`group relative aspect-3/4 overflow-hidden bg-[#111] transition-all duration-500 
                    ...
                    >
                        ...
                        {member.image ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center">
                                <span className="text-[#333] font-peakers text-[1vw]">WAITING FOR IMAGE</span>
                            </div>
                        )}
                        ...
                        <div className="absolute bottom-[1.5vw] left-[1.5vw]">
                            <span className="font-peakers text-[3.5vw] md:text-[0.9vw] font-bold tracking-wider text-white uppercase drop-shadow-md">
                                {member.label}
                            </span>
                        </div>

                ...
                <div className="w-[85%] flex justify-between items-stretch">
                    ...
                    <div className="w-[31%] h-[48vh] relative flex flex-col items-center text-center px-[2vw] py-[6vh] rounded-[0.5vw] overflow-hidden">
                        ...
                        <div className="relative z-10 w-full flex flex-col items-center">
                            <div className="w-[5vw] h-[5vw] relative flex items-center justify-center mb-[4vh]">
                                ...
                                <svg className="relative z-10 w-[1.8vw] h-[1.8vw]" width="30" height="27" viewBox="0 0 30 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className="font-peakers text-white text-[1.6vw] mb-[2vh] tracking-widest uppercase text-center">
                                PROPER FOOD
                            </h2>

                            <p className="text-gray-400 text-[0.8vw] tracking-[0.05vw] leading-[1.6vw] text-center">
                                FREE STAFF MEALS ON SHIFT. THE BEST CHICKEN IN TOWN,
                    ...
                    <div className="w-[31%] h-[48vh] relative flex flex-col items-center text-center px-[2vw] py-[6vh] rounded-[0.5vw] overflow-hidden">
                        ...
                        <div className="relative z-10 w-full flex flex-col items-center">
                            <div className="w-[5vw] h-[5vw] relative flex items-center justify-center mb-[4vh]">
                                ...
                                <svg className="relative z-10 w-[1.8vw] h-[1.8vw]" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-gray-400 text-[0.8vw] tracking-[0.05vw] leading-[1.6vw] text-center">
                                WORK HARD, PLAY HARD. WE BUILD THE ROTA AROUND YOUR LIFE,
                    ...
                    <div className="w-[31%] h-[48vh] relative flex flex-col items-center text-center px-[2vw] py-[6vh] rounded-[0.5vw] overflow-hidden">
                        ...
                        <div className="relative z-10 w-full flex flex-col items-center">
                            <div className="w-[5vw] h-[5vw] relative flex items-center justify-center mb-[4vh]">
                                ...
                                <svg className="relative z-10 w-[1.8vw] h-[1.8vw]" width="18" height="30" viewBox="0 0 18 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-gray-400 text-[0.8vw] tracking-[0.05vw] leading-[1.6vw] text-center">
                                FAST-PACED, LOUD MUSIC, GREAT PEOPLE. IT’S CHAOS,

...
export default function CareersLandingPage() {
    return (
        <motion.div
            ...
            className="w-full h-[82vh] bg-[#0000] flex flex-col items-center relative pt-[2vh]"
        >
            ...
            <div className="flex flex-col items-center text-center mt-6">
                ...
                <motion.div
                    ...
                    className="border-[0.05vw] rounded-[.2vw] font-mono border-[#6666] px-5 py-2 text-xs tracking-[0.45em] text-gray-300 mb-6"
                >
                    JOIN THE REVOLUTION
                </motion.div>
